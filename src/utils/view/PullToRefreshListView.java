...
public class PullToRefreshListView extends ListView implements AbsListView.OnScrollListener {
	...
	private void init(Context context) {
		...
		mRefreshViewImage =
				(ImageView) mRefreshHeaderView.findViewById(R.id.pull_to_refresh_arrow);
		mRefreshViewProgress =
				(ProgressBar) mRefreshHeaderView.findViewById(R.id.pull_to_refresh_circle_process_bar);
		mRefreshViewLastUpdated =
				(TextView) mRefreshHeaderView.findViewById(R.id.last_time_refresh_text);
		...
		mLoadMoreProgress = (ProgressBar) mLoadMoreFooterView.findViewById(R.id.load_more_progress);
